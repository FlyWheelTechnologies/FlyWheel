export default function ContactSection() {
  return (
    <div className="relative z-10 h-full w-full flex flex-col items-center justify-center gap-6 sm:gap-8 p-4 sm:p-6 text-center">
      <div className="flex-1 flex flex-col items-center justify-center gap-6 sm:gap-8">
        ...
        <div className="max-w-2xl space-y-6">
          ...
          <p className="text-sm sm:text-base text-white/50 max-w-lg mx-auto">
            Whether it's a brand-new product or an upgrade to what you already have, we'd love to hear from you.
          </p>
        ...
        <a 
          href="#home" 
          className="inline-flex items-center gap-2 rounded-2xl px-5 py-3 bg-white/10 hover:bg-white/15 ring-1 ring-white/20 backdrop-blur mt-8"
        >
      ...
      <div className="w-full border-t border-white/10 pt-4 pb-2">
        <p className="text-xs sm:text-sm text-white/30">
          © {new Date().getFullYear()} Flywheel Technologies
        </p>
      </div>
    </div>
  );
